...
\end{quotation}
Finally, the merge conflicts can get too severe, and developers have to resort to the \emph{Nuclear Option} (E5), where they scrap their changes and reimplement them:
\begin{quotation}
