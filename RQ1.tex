...
\toprule
  ...
  Tool\parnote{\textit{Processes Survey}~(S1) participants were allowed to provide multiple tools. 57 out of 102 participants (56\%) indicated the use of at least one merge awareness tool.} & Description & \multicolumn{2}{c}{Proactive\parnote{\label{tool_responses}Participants using this tool with the proactive or reactive strategy (percentages).}} & \multicolumn{2}{c}{Reactive\parnoteref{tool_responses}} & \multicolumn{2}{c}{Total\parnote{Total number of survey participants using each particular tool.}}\\
\midrule
