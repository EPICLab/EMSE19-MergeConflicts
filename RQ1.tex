...
\toprule
  ...
  \multicolumn{2}{|c}{No\parnote{\label{response}Participant responses to the survey question \textit{``do you monitor for merge conflicts?''} (percentage of experience range responses).}} &
  \multicolumn{2}{c|}{Yes/Sometimes\parnoteref{response}} & 
  \multicolumn{2}{c}{Proactive\parnote{\label{strategy}Participants that monitor for merge conflicts with the proactive or reactive strategy (percentage of 57 proactive/reactive responses).}} &
  \multicolumn{2}{c}{Reactive\parnoteref{strategy}} \\
  \aboverulesepcolor{shaded}
\midrule
  1--5 years & 12 & (36.4\%) & 21 & (63.6\%) & 6 & (27.3\%) & 16 & (72.7\%)\\
  \rowcolor[gray]{0.95}6--10 years & 8 & (29.6\%) & 19 & (70.4\%) & 5 & (31.3\%) & 11 & (68.7\%)\\
