...
Surprisingly, we found that two of our participants (2.53\% of respondents) indicated that they \textit{``[\ldots] don't have a strategy''} or \textit{``mostly try to fix it as soon as possible.''}
