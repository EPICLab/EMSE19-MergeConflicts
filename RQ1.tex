...
We asked developers in the \textit{Processes Survey}~(S1) to select, from this list of six conditions, all that they would consider to be a successful merge conflict resolution.
...
The survey respondents that selected \textit{code looks correct (i.e. visual test passes)} had a mean of $\sim$9.2 years of programming experience.
Inspecting code requires time and expertise in the area of conflicting code, and although these developers have prior development experience, they might not have a similar degree of experience in their codebase.
