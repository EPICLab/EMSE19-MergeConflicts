...
Practitioners indicate that their needs during merge conflict resolutions center around the retrieval, organization, and presentation of relevant information (N1, N3, N4 from Table~\ref{s2_needs}).
...
Before starting a merge conflict, we found practitioners having to \emph{``guess-timate''} the difficulty of the conflict resolution to decide whether to work on it now or delay it, or whether to integrate the changes or simply start over. 
...
Practitioners mentioned that passing tests (C1) and successful compilation (C2) are some of the criteria for success.
...
If developers had more information about \emph{why} the merge conflict resolution has failed, they might be able to recover more efficiently.
