...
Before starting a merge conflict, we found developers having to \emph{``guess-timate''} the difficulty of the conflict resolution to decide whether to work on it now or delay it, or whether to integrate the changes or simply start over. 
