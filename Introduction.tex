...
We use two surveys to split the topics into manageable lengths and reduce the fatigue on participants.
...
We found that the key challenges that developers face when resolving conflicts is \textit{understanding the conflicting code,} and having enough meta information about the conflicting code (who made the change, why, and when).
