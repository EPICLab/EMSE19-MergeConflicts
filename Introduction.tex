...
To understand the effects and implications of software developers' processes and strategies, we propose the following research questions:
...
\item We introduce a model of a developer process for merge conflict resolution, that addresses the phases between introduction and resolution of a conflict;
