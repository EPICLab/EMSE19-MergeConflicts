...
In the majority of cases the merges succeed, however research has show that, for open source projects, merge conflicts occur in approximately 19\% of all merges~\cite{cassandra,Brun2011}.
...
How do developers actually approach merge conflicts? 
