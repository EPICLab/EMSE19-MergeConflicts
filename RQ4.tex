...
This suggests that it might be enough for developers to rely on it when assesing the complexity of the conflicting code.
...
As with the factors in the previous section, all these needs also relate to \textit{technical aspects} (e.g., understanding the conflicting code) and their \textit{expertise} in resolving conflicts.\vspace{1.8em}
