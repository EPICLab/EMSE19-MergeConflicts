...
\begin{tabularx}{\textwidth}{lZ{0.57cm}r|cr|r}
  ...
  \rowcolor[gray]{0.85} Roles & \multicolumn{2}{c}{Participants\parnote{Number and percentage of \textit{Processes Survey} participants that selected each role; only one selection was allowed for (102 total responses).}} & \multicolumn{2}{c}{Soft. Dev. Experience\parnoteref{sde}} & Team Size\parnoteref{tsize} \\
  \midrule
