...
The only open-ended question in the Barriers Survey related to the tools that developers use to resolve merge conflicts; we tally the answers to this question and present the results in Section~.
...
We used Likert-type questions to measure the extent to which participants agreed with a particular statement.
...
The Barriers Survey did not contain open-ended questions, so no additionally qualitative analysis measures were required for the results.