...
We initially recruited developers from industry contacts or by soliciting contributors of various open-source projects.
These initial developers referred additional participants.
We accepted any referred participants with software development experience, and referred participants were not asked to refer additional participants.
This limitation follows best practices for snowball sampling~\cite{goodman1961snowball}, and allowed us to reduce the impact of any particular cohort of developers on the generalizability of our results.
...
\label{survey_roles}
\parnoteclear
\begin{tabularx}{\textwidth}{lZ{0.6cm}rcrr}
  \toprule
  \belowrulesepcolor{shaded}
  \rowcolor[gray]{0.85}\multicolumn{6}{l}{\textbf{Barriers Survey}} \\
  \rowcolor[gray]{0.85} Role & \multicolumn{2}{c}{Participants\parnote{Number and percentage of \textit{Barriers Survey} participants that selected each role; multiple selections were allowed (162 total responses).}} & \multicolumn{2}{c}{Soft. Dev. Experience\parnote{\label{sde}Percentile distribution of software development experience (on left) in ranges: 1--5 years, 6--10 years, 11--15 years, 16--20 years, 21--25 years, and 26+ years. Median selection (on right).}} & Team Size\parnote{\label{tsize}Median selection of primary team size.} \\
  \aboverulesepcolor{shaded}
  \midrule
  ...
  \rowcolor[gray]{0.95}System Architect & 54 & (33.33\%) & \likertplot{coordinates {(1,7.25)(2,31.88)(3,15.94)(4,21.74)(5,5.80)(6,17.39)}}{11.5}{5,22,11,15,4,12} & 11--15 years & 6--10 developers \\
  ...
  \rowcolor[gray]{0.95}Project Manager & 44 & (27.16\%) & \likertplot{coordinates {(1,9.26)(2,40.74)(3,12.96)(4,16.67)(5,5.56)(6,14.81)}}{9}{5,22,7,9,3,8} & 16--20 years & 2--5 developers \\
  ...
  \rowcolor[gray]{0.95}System Administrator & 23 & (14.20\%) & \likertplot{coordinates {(1,9.68)(2,38.71)(3,12.90)(4,16.13)(5,6.45)(6,16.13)}}{5.2}{3,12,4,5,2,5} & 11--15 years & 2--5 developers \\
  ...
  \rowcolor[gray]{0.85} Roles & \multicolumn{2}{c}{Participants\parnote{Number and percentage of \textit{Processes Survey} participants that selected each role; only one selection per participant was allowed (102 total responses).}} & \multicolumn{2}{c}{Soft. Dev. Experience\parnoteref{sde}} & Team Size\parnoteref{tsize} \\
  \aboverulesepcolor{shaded}
  \midrule
  ...
  \rowcolor[gray]{0.95}Engineer & 39 & (38.61\%) & \likertplot{coordinates {(1,38.46)(2,28.21)(3,10.26)(4,15.38)(5,7.69)(6,0.00)}}{9.44}{15,11,4,6,3,0} & 6--10 years & 6--10 developers \\
  ...
  \rowcolor[gray]{0.95}DevOps & 7 & (6.93\%) & \likertplot{coordinates {(1,42.86)(2,14.29)(3,42.86)(4,0.00)(5,0.00)(6,0.00)}}{7.29}{3,1,3,0,0,0} & 6--10 years & 6--10 developers \\
  Designer & 1 & (0.99\%) & \likertplot{coordinates {(1,50.00)(2,0.00)(3,0.00)(4,0.00)(5,0.00)(6,0.00)}}{5.00}{1,0,0,0,0,0} & 1--5 years & 1 developer \\
  \rowcolor[gray]{0.95}Other & 7 & (6.93\%) & \likertplot{coordinates {(1,57.14)(2,14.29)(3,0.00)(4,14.29)(5,14.29)(6,0.00)}}{8.43}{4,1,0,1,1,0} & 1--5 years & 2--5 developers \\
  \bottomrule
\end{tabularx}
\parnotes
\end{table}
...
The \textit{Processes Survey} contained five open-ended questions.
...
For questions 8 (\textit{``How do you determine the urgency of a merge conflict?''}), 11 (\textit{``What is your first step in trying to understand code involved in a merge conflict?''}), 14 (\textit{``What effect did deferring your response to a merge conflict have on the resolution of the conflict?''}), and 19 (\textit{``If your first attempt at resolving a merge conflict fails, what backup strategies do you use?''}), we achieve high IRR agreements of $0.81$, $0.88$, $0.74$, and $0.92$, respectively.
...
%For comparison purposes, we similarly grouped the results from the \textit{Processes Survey} and the \textit{Barriers Survey}.
...
\begin{figure}[!htbp]
\centering
\fbox{\includegraphics[width=0.98\textwidth,keepaspectratio]{imgs/population.png}}
...
%\begin{table}[!htbp]
%\centering
%\caption{Codebook used for coding open-ended responses from Processes Survey}
%\label{tab:codes}
