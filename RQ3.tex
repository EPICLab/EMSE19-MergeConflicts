...
\toprule
  ...
  Condition & Description & Selections\parnote{\label{toolsets}\textit{Processes Survey} participants were allowed to select multiple conditions. 79 out of 89 participants (89\%) selected multiple conditions.} & Percentage\parnoteref{toolsets} \\
  \aboverulesepcolor{shaded}
\midrule
  C1 & All tests pass & 67 & (75.28\%) \\
  \rowcolor[gray]{0.95}C2 & Code successfully compiles & 67 & (75.28\%) \\
  C3 & Code looks correct (i.e. visual test passes) & 66 & (74.16\%) \\
  \rowcolor[gray]{0.95}C4 & VCS warnings are gone & 51 & (57.30\%) \\
  C5 & Merged code is approved during code review & 38 & (42.70\%) \\
  \rowcolor[gray]{0.95}C6 & Merged code accepted into production codebase & 33 & (37.08\%) \\
  C7 & Other & 2 & (2.25\%) \\
\bottomrule
\end{tabularx}
\parnotes
